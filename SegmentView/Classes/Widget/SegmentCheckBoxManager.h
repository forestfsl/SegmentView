...
@protocol SegmentCheckBoxManagerDelegate;

/** The different type of boxes available.
 * @see boxType
 */
typedef NS_ENUM(NSInteger,STORYBOARDBoxType) {
    /** Circled box.
     */
   STORYBOARDBoxTypeCircle,
    
    /** Squared box.
     */
   STORYBOARDBoxTypeSquare
};
...
IB_DESIGNABLE @interface SegmentCheckBoxManager : UIControl <CAAnimationDelegate>
#else
IB_DESIGNABLE @interface SegmentCheckBoxManager : UIControl
#endif
...
* @discussion The delegate must adopt the \p SegmentCheckBoxManagerDelegate protocol. The delegate is not retained.
 */
@property (nonatomic, weak) IBOutlet id <SegmentCheckBoxManagerDelegate> delegate;

/** This property allows you to retrieve and set (without animation) a value determining whether the SegmentCheckBoxManager object is On or Off.
  * Default to NO.
 */
...
/** The corner radius which is applied to the box when the boxType isSTORYBOARDBoxTypeSquare. Default to 3.0.
 */
 ...
 */
@property (strong, nonatomic, nullable, readonly) SegmentCheckBoxGroup *group;

/** The type of box.
 * @seeSTORYBOARDBoxType.
 */
...
/** The SegmentCheckBoxManagerDelegate protocol. Used to receive life cycle events.
 */
@protocol SegmentCheckBoxManagerDelegate <NSObject>
 ...
 * @param checkBox The SegmentCheckBoxManager instance that has been tapped.
 */
- (void)didTapCheckBox:(SegmentCheckBoxManager*)checkBox;
 ...
 * @param checkBox The SegmentCheckBoxManager instance that was animated.
 */
- (void)animationDidStopForCheckBox:(SegmentCheckBoxManager *)checkBox;
