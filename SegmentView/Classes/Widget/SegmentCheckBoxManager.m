...
/** The SegmentAnimationManager object used to generate animations.
 */
@property (strong, nonatomic) SegmentAnimationManager *animationManager;

/** The SegmentPathManager object used to generate paths.
 */
@property (strong, nonatomic) SegmentPathManager *pathManager;
...
@implementation SegmentCheckBoxManager
...
- (void)initPathManager {
    _pathManager = [SegmentPathManager new];
...
- (void)initAnimationManager {
    _animationManager = [[SegmentAnimationManager alloc] initAnimationDuration:_animationDuration];
}
...
- (void)setBoxType:(STORYBOARDBoxType)boxType {
    _boxType = boxType;
...
- (void)drawOffBox {
    ...
    self.offBoxLayer.path = [self.pathManager pathForBoxForDevice].CGPath;
...
- (void)drawOnBox {
    ...
    self.onBoxLayer.path = [self.pathManager pathForBoxForDevice].CGPath;
...
- (void)drawCheckMark {
    ...
    self.checkMarkLayer.path = [self.pathManager pathForCheckMarkForDevice].CGPath;
...
- (void)addOnAnimation {
    ...
    switch (self.onAnimationType) {
        case BEMAnimationTypeStroke: {
            CABasicAnimation *animation = [self.animationManager ForPlatformStrokeAnimationBoardReverse:NO];
        ...
        case BEMAnimationTypeFill: {
            CAKeyframeAnimation *wiggle = [self.animationManager ForPlatformFillAnimationBoardBounces:1 amplitude:0.18 reverse:NO];
            CABasicAnimation *opacityAnimation = [self.animationManager ForPlatformOpacityAnimationBoardReverse:NO];
        ...
        case BEMAnimationTypeBounce: {
            CGFloat amplitude = (self.boxType ==STORYBOARDBoxTypeSquare) ? 0.20 : 0.35;
            CAKeyframeAnimation *wiggle = [self.animationManager ForPlatformFillAnimationBoardBounces:1 amplitude:amplitude reverse:NO];
            wiggle.delegate = self;
            
            CABasicAnimation *opacity = [self.animationManager ForPlatformOpacityAnimationBoardReverse:NO];
        ...
        case BEMAnimationTypeFlat: {
            CABasicAnimation *morphAnimation = [self.animationManager ForPlatformmorrphAnimationFromBoardPath:[self.pathManager pathForFlatCheckMarkForDevice] toPath:[self.pathManager pathForCheckMarkForDevice]];
        ...
        case BEMAnimationTypeOneStroke: {
            ...
            self.checkMarkLayer.path = [[self.pathManager pathForLongCheckMarkForDevice] bezierPathByReversingPath].CGPath;
            
            CABasicAnimation *boxStrokeAnimation = [self.animationManager ForPlatformStrokeAnimationBoardReverse:NO];
            ...
            CABasicAnimation *checkStrokeAnimation = [self.animationManager ForPlatformStrokeAnimationBoardReverse:NO];
            ...
            CABasicAnimation *checkMorphAnimation = [self.animationManager ForPlatformmorrphAnimationFromBoardPath:[self.pathManager pathForLongCheckMarkForDevice] toPath:[self.pathManager pathForCheckMarkForDevice]];
        ...
        default: {
            CABasicAnimation *animation = [self.animationManager ForPlatformOpacityAnimationBoardReverse:NO];
...
- (void)addOffAnimation {
    ...
    switch (self.offAnimationType) {
        case BEMAnimationTypeStroke: {
            CABasicAnimation *animation = [self.animationManager ForPlatformStrokeAnimationBoardReverse:YES];
            [self.onBoxLayer addAnimation:animation forKey:@"strokeEnd"];
            animation.delegate = self;
            [self.checkMarkLayer addAnimation:animation forKey:@"strokeEnd"];
        }
        ...
        case BEMAnimationTypeFill: {
            CAKeyframeAnimation *wiggle = [self.animationManager ForPlatformFillAnimationBoardBounces:1 amplitude:0.18 reverse:YES];
            wiggle.duration = self.animationDuration;
            wiggle.delegate = self;
            
            [self.onBoxLayer addAnimation:wiggle forKey:@"transform"];
            [self.checkMarkLayer addAnimation:[self.animationManager ForPlatformOpacityAnimationBoardReverse:YES] forKey:@"opacity"];
        }
            return;
            
        case BEMAnimationTypeBounce: {
            CGFloat amplitude = (self.boxType ==STORYBOARDBoxTypeSquare) ? 0.20 : 0.35;
            CAKeyframeAnimation *wiggle = [self.animationManager ForPlatformFillAnimationBoardBounces:1 amplitude:amplitude reverse:YES];
            wiggle.duration = self.animationDuration / 1.1;
            CABasicAnimation *opacity = [self.animationManager ForPlatformOpacityAnimationBoardReverse:YES];
        ...
        case BEMAnimationTypeFlat: {
            CABasicAnimation *animation = [self.animationManager ForPlatformmorrphAnimationFromBoardPath:[self.pathManager pathForCheckMarkForDevice] toPath:[self.pathManager pathForFlatCheckMarkForDevice]];
            animation.delegate = self;
        ...
        case BEMAnimationTypeOneStroke: {
            ...
            CABasicAnimation *checkMorphAnimation = [self.animationManager ForPlatformmorrphAnimationFromBoardPath:[self.pathManager pathForCheckMarkForDevice] toPath:[self.pathManager pathForLongCheckMarkForDevice]];
            checkMorphAnimation.delegate = nil;
            checkMorphAnimation.duration = checkMorphAnimation.duration / 6;
            [self.checkMarkLayer addAnimation:checkMorphAnimation forKey:@"path"];
            
            CABasicAnimation *checkStrokeAnimation = [self.animationManager ForPlatformStrokeAnimationBoardReverse:YES];
            ...
            CABasicAnimation *boxStrokeAnimation = [self.animationManager ForPlatformStrokeAnimationBoardReverse:YES];
        ...
        default: {
            CABasicAnimation *animation = [self.animationManager ForPlatformOpacityAnimationBoardReverse:YES];
